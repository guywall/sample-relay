...
class PBSR_Zoho_Books {
    ...
    public function findOrCreateCustomer(array $data) {
        ...
        PBSR_Zoho_Field_Manager::applyBooksMappings(
            $payload,
            $data['field_values'] ?? [],
            $this->settings['mapping_rules'] ?? [],
            PBSR_Zoho_Field_Manager::getCachedFields('books_contact'),
            'books_contact'
        );
