...
class PBSR_Product_Selection_Form {
    ...
    public static function enqueue_assets() {
        $css = '.pb-step[hidden]{display:none!important}#pb-samples-form .pb-products{display:grid;grid-template-columns:repeat(4,minmax(0,1fr))!important;gap:12px!important}#pb-samples-form .pb-card{border:1px solid #ccc;padding:12px}#pb-samples-form .pb-card img{width:100%;height:auto}#pb-samples-form .pb-card.is-selected{outline:2px solid #ff9f23}#pb-samples-form .pb-nav{display:flex;gap:10px;justify-content:flex-end;margin-top:16px}#pb-samples-form .pb-review-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:12px}#pb-samples-form .pb-review-tile{aspect-ratio:1/1;position:relative;overflow:hidden}#pb-samples-form .pb-review-tile img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover}@media(max-width:1024px){#pb-samples-form .pb-products{grid-template-columns:repeat(3,minmax(0,1fr))!important}}@media(max-width:768px){#pb-samples-form .pb-products{grid-template-columns:repeat(2,minmax(0,1fr))!important}}@media(max-width:640px){#pb-samples-form .pb-review-grid{grid-template-columns:repeat(2,1fr)}}';
